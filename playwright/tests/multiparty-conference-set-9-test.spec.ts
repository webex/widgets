...
import {acceptIncomingTask, declineIncomingTask, waitForIncomingTask} from '../Utils/incomingTaskUtils';
...
import {ACCEPT_TASK_TIMEOUT, CONSULT_NO_ANSWER_TIMEOUT, TASK_TYPES, USER_STATES, WRAPUP_REASONS} from '../constants';
...
export default function createMultipartyConferenceSet9Tests() {
  ...
  const getRequiredEnv = (suffix: string): string => getConferenceRequiredEnv(testManager.projectName, suffix);

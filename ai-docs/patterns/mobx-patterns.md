...
- [`ARCHITECTURE.md`](../ARCHITECTURE.md#state-management) - Store architecture
- [`DEVELOPMENT.md`](../DEVELOPMENT.md#mobx-usage) - Development standards
...
- [Store Singleton Pattern](./patterns/store-singleton.md)
- [Store Wrapper Pattern](./patterns/store-wrapper.md)
- [Observer Component Pattern](./patterns/observer-component.md)
- [runInAction Usage](./patterns/runInAction-usage.md)

## Diagrams

![State Management](./diagrams/state-management.svg)
![Event Handling](./diagrams/event-handling.svg)

...
were rejected. Unlike temporary generation records, ADRs live with the repo forever, so an agent sees
the reasoning behind a constraint instead of "fixing" it by accident.
...
- **Fill-in shape:** see `0001-one-directional-dependency-flow.md` (Context · Decision · Alternatives Considered · Consequences · Revisit When).
...
Each ADR carries a navigation pointer back to the root `../../AGENTS.md`, router `../SPEC_INDEX.md`, and

...
| `STATION-LOGIN-R-013`  | `cc-components/tests/.../e911-modal.test.tsx` Cancel-button and native-`close`-event cases                                                        | Boundary-only entry; no test exists (or is expected) in this package                                  |

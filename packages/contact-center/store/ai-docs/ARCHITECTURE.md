...
| ----------------- | --------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| Initialization    | `register()`, `LoggerProxy`                                                       | `agent:dnRegistered`, `agent:reloginSuccess`                                                                         | `init()`, `registerCC()`, `setupIncomingTaskHandler()`                                                    |
| Agent Session     | `stationLogin()`, `stationLogout()`, `deregister()`                               | `agent:stationLoginSuccess`, `agent:logoutSuccess`, `agent:multiLogin`                                               | `cleanUpStore()`, `setShowMultipleLoginAlert()`                                                           |
| Agent State       | `setAgentState()`                                                                 | `agent:stateChange`                                                                                                  | `handleStateChange()`, `setCurrentState()`, timestamp setters                                             |
| Tasks             | `cc.taskManager.getAllTasks()`                                                    | `task:incoming`, `task:assigned`, `task:end`, `task:hydrate`, `task:merged`, consult/conference events, media events | `registerTaskEventListeners()`, `refreshTaskList()`, `setCurrentTask()`, consult handlers, media handling |

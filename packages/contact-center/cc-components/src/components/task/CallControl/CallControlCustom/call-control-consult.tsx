...
// Added new prop consultCompleted to drive the transfer button state.
  ...
  const buttons = [
    {
      ...
      disabled: !consultCompleted, // transfer button enabled when consultCompleted is true
    },
    {
      key: 'cancel',
      icon: 'headset-muted-bold',
      tooltip: 'End Consult',
      onClick: endConsultCall, // calls the helper method to end consult
  ...
  return (
    <div className="call-control-consult">
      <div className="consult-task-header" style={{display: 'flex', alignItems: 'center', marginBottom: '0.5rem'}}>
        ...
        <div className="consult-task-details" style={{display: 'flex', flexDirection: 'column', marginLeft: '8px'}}>
